            ...
            <ul class="metismenu" id="sidenav">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="#"><i class="material-icons-outlined">arrow_right</i>View Products</a>
                        </li>
                        <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Add Category</a>
                        </li>
                        <li><a href="#"><i class="material-icons-outlined">arrow_right</i>View Category</a>
                        </li>
